...
No, county_voters 2022 has title case for the "total' column, whereas all the other ones have it in all caps
```{r}
...
The county is growing, shown by the increase in unaffiliated voters and other. 
...
It should be 24 and there are still 24. 
...
GEOCODE, county, and county population by race.
