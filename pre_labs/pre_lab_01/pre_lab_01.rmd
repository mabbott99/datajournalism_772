...
In the space below, write the data type for the "id" column and the "seats" column (it's in light gray, offset by \< \>). **Answer** character and double (which is just a number)
...
**Answer** Organize each class by term, when each class is, what type of class it is, etc.
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer** more students are coming, meaning more money for the school or university
...
**Answer** it is now seperated by dept. The code (term,dept) changed it
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer** we can now see the number of seats in each course
...
Compared to the previous codeblock, what has changed and how did that affect the result? What do the top terms have in common? **Answer** we now have the mean and the median of seats
...
**Answer** we now have min and max amount of seats
...
1.  What is the minimum amount of seats for courses in English?

2.  What is the maximum amount of seats for courses in the Business dept?

3.  What is the median amount of seats for all the courses available?
