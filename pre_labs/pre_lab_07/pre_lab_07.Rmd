...
```{r echo=FALSE}
census_api_key("fe977fabda8a0b7b6a0a516c0563730d252f6b35", install=TRUE)
...
**Task** Run the following codeblock to find the Maryland county with the highest median household income and put the answer below. **Answer** Howard County with roughly $129 thousand. It is almost certainly the wealthiest county in Maryland.
...
Margin or Error from the average household income by county in MD
...
Is the difference between Calvert and Montgomery significant? **Answer** No, there overlap. It is just that Montgomery has a lower margin of error.
...
Baltimore City as a result of gentrification and lower-income families being pushed out of the city. Allegany County is also pretty high. 

No county's median income fell, but Caroline County saw the smallest increase.
...
We can ask what is the percentage of high school graduated that enrolled in college from x school and do we see a correlation to median income?

Something that could make the answer harder to interpret could be dependent on how big or small the population and what the margin of error is for that area. 
...
Schools with more students have a higher chance of their students going to college.
...
We can ask if there is any zip code/area or high school in which the the college enrollment percentage is high but median income is relatively low. 