...
https://www.datawrapper.de/_/9cMLj/
...
Prior to selecting "hide regions without data", we can see a map of every county in the USA, with most of it colored in grey. However, you can vaguely see Maryland is colored with different shades of blue which is b/c we have the data available for the counties in Maryland. 

After selecting the tab, we can only see the whole state of Maryland, and the counties are colored with different shades of blue. 
...
Now, when you hover over the counties in MD, you can clearly see what county is which and it gives a clear percentage in the format that most humans read percentages. It is no longer confusing, even to someone who doesn't know much about politics or the state of Maryland. 
...
https://www.datawrapper.de/_/877d4/
