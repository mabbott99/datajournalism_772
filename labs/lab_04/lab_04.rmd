...
library(readr)
lab_04_media_expenses_khi <- read_csv("~/datajour/datajournalism_772/labs/lab_04/data/lab_04_media_expenses_khi.csv")
  
lab_04_media_expenses_khi |> 
...
**A4.** 
From what I have, the top 7 of this list completely differs from the list I got for the first question. I only ended up getting 7 results total for the first question. It looks like Jain Ashwani and friends spent all of their money with Facebook. 
...
**A5**
It seems as if a lot of money is spent on media and online advertising. An interesting story could be diving into how effective these Facebook advertisements are, and how maybe they could utilize that money in different ways.