...
**A1:** This dataset contains data about all earthquakes from September 11 to October 11 all across the globe. This includes location, axis point, magnitude, date and time plus more. 
...
**A2:**
There are 9,774 records in total. We can gather where the earthquake happened, what time it happened, how strong it was, the depth of the earthquake and even more information that the typical person likely will not understand. 
------------------------------------------------------------------------
...
**A3:**
The deepest one is 669.982 and its magnitude was 4.2.
...
**A7:**
You should look at the place column, and then you can string detect and then write (place, "Alaska") and I ended up getting 3,446.
------------------------------------------------------------------------
...
**A8:**
earthquake and quarry blast are the two most common types of tremors. 
------------------------------------------------------------------------
...
**A9:**
25.23796. When I looked up the average depth of an earthquake, it is usually 10 km. Here, the average is 25.2, so prehaps earthquakes are getting stronger? That's interesting. 
------------------------------------------------------------------------
...
**A10:**
Use mutate (:
You will use mutate to create a new column in order to show what hour each earthquake occurred and then you name it.
------------------------------------------------------------------------
...
**A12**:
Hour 12 has the least amount of serious earthquakes. The hour with the most serious is 2.
------------------------------------------------------------------------

#### **Q13** What's another question you are interested in and how would you ask it in R?

Q: How many earthquakes occurred in the Fiji Region?

```{r}
earthquakes |>
  filter(str_detect(place, "Fiji region"))
```
16